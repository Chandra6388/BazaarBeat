...
const Dashboard = () => {
  ...
  const getUsers = async () => {
    const req = { filter_type: selectedTimeFilter, start_date: "", end_date: "" }
  ...
  console.log("usersArr.currectUserData", Number(usersArr.percentage_change.total_user))
  const statsData = {
    day: [
      ...
      <div className="flex w-full min-h-screen bg-gradient-to-br from-[#001430] to-[#031a3d] font-sans">
        ...
        >
          ...
          <div className="p-6">
            <DashboardHeader
              title="Dashboard"
              subtitle={`Welcome back, ${UserDetails?.FirstName} ${UserDetails.LastName}`}
