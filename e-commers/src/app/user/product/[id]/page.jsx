...
const Product = () => {
    ...
    const getProduct = async () => {
        ...
        await getProductById(req)
            .then((res) => {
                if (res.status) {
                    setSigleProduct(res.data)
                }
                else {
                    setSigleProduct(null)
                }
            }).catch((error) => {
                console.log("error in finding singale product", error)
            })
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center mt-10 gap-4">
                        <button onClick={() => addToCart(getSingleProduct?._id)} className="w-full py-3.5 bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition">
                            Add to Cart
                        </button>
